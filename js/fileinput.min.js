...
! function(e) {
    ...
    var i = function(e) {
        ...
        t = {
            ...
            footer: function(e, i, a) {
                ...
                var r = n.config[i],
                    ...
                    p = s === !1 && a,
                    c = n.isDelete ? n.actions(!1, !0, p, s, d) : "",
                    u = n.footer.repl("{actions}", c);
        ...
        c = {
            ...
            removeClass: "btn btn-sm btn-link",
            removeTitle: "Remove file",
            uploadIcon: '<i class="glyphicon glyphicon-upload text-info"></i>',
            uploadClass: "btn btn-sm btn-link",
        ...
        f = '{preview}\n<div class="kv-upload-progress hide"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n',
        v = '<div class="file-preview {class}">\n    <div class="close fileinput-remove"><i class="far fa-times-circle close-btn fa-lg"></i></div>\n    <div class="{dropClass}">\n    <div class="file-preview-thumbnails">\n    </div>\n    <div class="clearfix"></div>    <div class="file-preview-status text-center text-success"></div>\n    <div class="kv-fileinput-error"></div>\n    </div>\n</div>',
    ...
    H.prototype = {
        ...
        raise: function(i, t) {
            var a = this,
                n = e.Event(i);
            if (void 0 !== t ? a.$element.trigger(n, t) : a.$element.trigger(n), !n.result) return !1;
            switch (i) {
        ...
        renderFileActions: function(e, i, t, a, n) {
            ...
            var r = this,
                ...
                d = "",
                p = r.getLayoutTemplate("actions"),
                c = r.otherActionButtons.repl("{dataKey}", o),
                u = r.fileActionSettings,
                f = t ? u.removeClass + " disabled" : u.removeClass;
            return s = s.repl("{removeClass}", f).repl("{removeIcon}", u.removeIcon).repl("{removeTitle}", u.removeTitle).repl("{dataUrl}", l).repl("{dataKey}", o), e && (d = r.getLayoutTemplate("actionUpload").repl("{uploadClass}", u.uploadClass).repl("{uploadIcon}", u.uploadIcon).repl("{uploadTitle}", u.uploadTitle)), p.repl("{delete}", s).repl("{upload}", d).repl("{other}", c)
        },
        ...
        initPreviewDeletes: function() {
            ...
            i.$preview.find(".kv-file-remove").each(function() {
                var r = e(this),
                    ...
                    s = r.data("key");
                if (!R(l) && void 0 !== s) {
                    var d, p, c, u, f = r.closest(".file-preview-frame"),
                        v = t.data[i.id],
                        h = f.data("fileindex");
                    h = parseInt(h.replace("init_", "")), c = R(v.config) && R(v.config[h]) ? null : v.config[h], u = R(c) || R(c.extra) ? a : c.extra, "function" == typeof u && (u = u()), p = {
                        id: r.attr("id"),
                        key: s,
                        extra: u
                    }, d = e.extend({
                        ...
                        error: function(e, t, a) {
                            ...
                            p.jqXHR = e, p.response = {}, i.showError(r, p, "filedeleteerror"), f.removeClass("file-uploading"), n()
                        }
        ...
        initUploadSuccess: function(i, a, n) {
            var r, l, o, s, d, p, c, u = this;
            "object" != typeof i || e.isEmptyObject(i) || void 0 !== i.initialPreview && i.initialPreview.length > 0 && (u.hasInitData = !0, d = i.initialPreview || [], p = i.initialPreviewConfig || [], c = i.initialPreviewThumbTags || [], r = void 0 === i.append || i.append ? !0 : !1, u.overwriteInitial = !1, void 0 === a || n ? n ? (u.uploadCache.content.push(d[0]), u.uploadCache.config.push(p[0]), u.uploadCache.tags.push(c[0]), u.uploadCache.append = r) : (t.set(u.id, d, p, c, r), u.initPreview(), u.initPreviewDeletes()) : (o = t.add(u.id, d, p[0], c[0], r), l = t.get(u.id, o, !1), s = e(l).hide(), a.after(s).fadeOut("slow", function() {
                s.fadeIn("slow").css("display:inline-block"), u.initPreviewDeletes(), u.clearFileInput()
            })))
        },
        initThumbDelete: function(e) {
            var i = this;
            e.find(".kv-file-remove").removeAttr("disabled").off("click").on("click", function() {
                var t = i.raise("filesuccessremove", [e.attr("id"), e.data("fileindex")]);
                t !== !1 && e.fadeOut("slow", function() {
                    e.remove(), i.$preview.find(".file-preview-frame").length || i.reset()
                })
            })
        },
        uploadSingle: function(i, a, n) {
            var r, l, s, d, p, c, u, f, v, h = this,
            ...
            h.formdata = g, 0 === m || !y || C.hasClass("disabled") || h.abort(T) || (s = function() {
                ...
                r = h.getOutData(t), b.hasClass("file-preview-success") || (h.setThumbStatus(b, "Loading"), o(b, "file-uploading")), C.attr("disabled", !0), x.attr("disabled", !0), n || h.lock(), h.raise("filepreupload", [r, w, i]), T = e.extend(T, r), h.abort(T) && (t.abort(), h.setProgress(100))
            }, u = function(t, a, l) {
                r = h.getOutData(l, t), T = e.extend(T, r), setTimeout(function() {
                    void 0 === t.error ? (h.setThumbStatus(b, "Success"), C.hide(), h.initThumbDelete(b), h.filestack[i] = void 0, h.raise("fileuploaded", [r, w, i]), h.initUploadSuccess(t, b, n), n || h.resetFileStack()) : (h.setThumbStatus(b, "Error"), h.showUploadError(t.error, T))
                }, 100)
            }, f = function() {
                setTimeout(function() {
                    d(), p(), n ? s() : h.unlock(!1)
            ...
            }, g.append(h.uploadFileAttr, a[i]), g.append("file_id", i), h.ajaxSubmit(c, u, f, v))
        },
        uploadBatch: function() {
            ...
            l.formdata = new FormData, 0 !== d && p && !l.abort(c) && (i = function() {
                ...
                void 0 === t.error || R(t.error) ? (l.raise("filebatchuploadsuccess", [r]), i(), l.showPreview ? (o.each(function() {
                    var i = e(this),
                        t = i.find(".kv-file-upload");
                    i.find(".kv-file-upload").hide(), l.setThumbStatus(i, "Success"), i.removeClass("file-uploading"), t.removeAttr("disabled"), l.initThumbDelete(i)
                }), l.initUploadSuccess(t)) : l.reset()) : (l.showPreview && (o.each(function() {
                    var i = e(this),
                        t = i.find(".kv-file-remove"),
                        a = i.find(".kv-file-upload");
                    return i.removeClass("file-uploading"), a.removeAttr("disabled"), t.removeAttr("disabled"), 0 === s.length ? void l.setThumbStatus(i, "Error") : void(-1 !== e.inArray(key, s) ? l.setThumbStatus(i, "Error") : (i.find(".kv-file-upload").hide(), l.setThumbStatus(i, "Success"), l.initThumbDelete(i), l.filestack[key] = void 0))
                }), l.initUploadSuccess(t)), l.showUploadError(t.error, r, "filebatchuploaderror"))
            }, n = function() {
                l.setProgress(100), l.unlock(), l.raise("filebatchuploadcomplete", [l.filestack, l.getExtraData()]), l.clearFileInput()
            }, r = function(i, t, a) {
        ...
        readFiles: function(i) {
            function t(e) {
                ...
                if (!R(P) && z(P)) {
                    for (w = 0; w < P.length; w += 1) C = P[w], g = f[C], x = void 0 !== g && g(E.type, k), I += R(x) ? 0 : x.length;
                    if (0 === I) return b = a.msgInvalidFileType.repl("{name}", k).repl("{types}", S), void(a.isError = h(b, E, T, e))
                }
                return 0 !== I || R(U) || !z(U) || R($) || (x = k.match($), I += R(x) ? 0 : x.length, 0 !== I) ? a.showPreview ? (r.length > 0 && void 0 !== FileReader ? (s.html(d.repl("{index}", e + 1).repl("{files}", u)), o.addClass("loading"), l.onerror = function(e) {
                    a.errorHandler(e, k)
                }, l.onload = function(e) {
                    a.previewFile(E, e, T, D), a.initFileActions()
                }, l.onloadend = function() {
                    b = p.repl("{index}", e + 1).repl("{files}", u).repl("{percent}", 50).repl("{name}", k), setTimeout(function() {
                        s.html(b), q.revokeObjectURL(D)
                    ...
                    if (i.lengthComputable) {
                        var t = i.loaded / i.total * 100,
                            a = Math.ceil(t);
                        b = p.repl("{index}", e + 1).repl("{files}", u).repl("{percent}", a).repl("{name}", k), setTimeout(function() {
                            s.html(b)
                        }, 100)
                    }
        ...
        change: function(i) {
            ...
            var r, l, o, s, d = a.$preview,
                ...
                c = p ? i.originalEvent.dataTransfer.files : n.get(0).files,
                u = R(n.attr("multiple")),
                f = 0,
                v = 0,
            ...
            if (a.reader = null, a.resetUpload(), a.hideFileIcon(), a.isUploadable && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), p)
                for (r = []; c[f];) s = c[f], s.type || s.size % 4096 !== 0 ? r.push(s) : v++, f++;
            ...
            a.isIE9 ? a.updateFileDetails(1) : a.readFiles(r), a.showFolderError(v)
        },
        ...
        browseClass: "btn btn-sm btn-link",
        removeIcon: '<i class="fas fa-trash-alt"></i> ',
        removeClass: "btn btn-sm btn-link",
        cancelIcon: '<i class="fas fa-ban"></i> ',
        cancelClass: "btn btn-sm btn-link",
        ...
        msgValidationErrorIcon: '<i class="fas fa-info-circle"></i> ',

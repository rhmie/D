...
<?php
	...
	$sql	=	'SELECT A1.*, A2.id AS pid, A2.images, A2.pname, A2.price, A2.sprice, A2.sdate FROM discount_products A1, products A2 WHERE A2.id = A1.pid ORDER BY A1.id DESC LIMIT '.$icount.', 6';
	...
	foreach ($prods as $prod){
		...
		<div class="btn-group">
				...
				<button data-pid="'.$prod['id'].'" class="btn btn-blue-grey btn-sm del_dis"><i class="fas fa-trash-alt mr-1"></i>刪除</button>
			</div>
		</td>';
